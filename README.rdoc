...
To enable redirects from http to https sites on the same domain (i.e: http://www.facebook.com -> https://www.facebook.com) you can pass allow_unsafe_redirects as an option. If this option is not specified or is false an exception is thrown on redirects.

  page = MetaInspector.new('facebook.com', :allow_unsafe_redirects => true)
