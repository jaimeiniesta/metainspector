...
MetaInspector allows safe redirects from http to https sites by default (i.e: http://www.facebook.com -> https://www.facebook.com). Passing allow_safe_redirections as false will throw exceptions on such redirects.
