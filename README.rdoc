...
To enable redirects from http to https sites on the same domain (i.e: http://www.facebook.com -> https://www.facebook.com) you can pass allow_safe_redirections as an option. If this option is not specified or is false an exception is thrown on all redirects.

  page = MetaInspector.new('facebook.com', :allow_safe_redirections => true)
