...
describe MetaInspector do
  describe "#images" do
    describe "returns an Enumerable" do
      let(:page) { MetaInspector.call('https://twitter.com/markupvalidator') }
    ...
    it "should find all page images" do
      page = MetaInspector.call('http://pagerankalert.com')
    ...
    it "should find images on twitter" do
      page = MetaInspector.call('https://twitter.com/markupvalidator')
    ...
    it "should ignore malformed image tags" do
      ...
      page = MetaInspector.call("http://www.guardian.co.uk/media/pda/2011/sep/15/techcrunch-arrington-startups")
  ...
  describe "images.best" do
    it "should find the og image" do
      page = MetaInspector.call('http://www.theonion.com/articles/apple-claims-new-iphone-only-visible-to-most-loyal,2772/')
    ...
    it "should find image on youtube" do
      page = MetaInspector.call('http://www.youtube.com/watch?v=iaGSSrp49uc')
    ...
    it "should find image when og:image and twitter:image metatags are missing" do
      page = MetaInspector.call('http://example.com/largest_image_using_image_size')
    ...
    it "should find image when og:image and twitter:image metatags are present but empty" do
      page = MetaInspector.call('http://example.com/meta_tags_empty')

      expect(page.images.best).to eq("http://example.com/100x100")
    end

    it "should find image when some img tag has no src attribute" do
      page = MetaInspector.call('http://example.com/malformed_image_in_html')
  ...
  describe "images.owner_suggested" do
    ...
    it "should absolutify image" do
      page = MetaInspector.call('http://www.24-horas.mx/mexico-firma-acuerdo-bilateral-automotriz-con-argentina/')
  ...
  describe "images.with_size" do
    it "should return sorted by area array of [img_url, width, height] using html sizes" do
      page = MetaInspector.call('http://example.com/largest_image_in_html')
    ...
    it "should return sorted by area array of [img_url, width, height] without downloading images" do
      page = MetaInspector.call('http://example.com/largest_image_using_image_size', download_images: false)
  ...
  describe '#favicon' do
    ...
    it "should get favicon link when marked as shortcut" do
      page = MetaInspector.call('http://pagerankalert-shortcut.com/')
    ...
    it "should get favicon link when marked as shorcut and icon" do
      page = MetaInspector.call('http://pagerankalert-shortcut-and-icon.com/')
    ...
    it "should get favicon link when there is also a touch icon" do
      page = MetaInspector.call('http://pagerankalert-touch-icon.com/')
