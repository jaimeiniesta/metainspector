  ...
  describe "redirections" do
    ...
    describe "unsafe redirections (HTTPS to HTTP)" do
      it "disallows unsafe redirections by default" do
        ...
        m = MetaInspector.new("https://unsafe-facebook.com", exception_log: logger)
        m.title
      end
      ...
      it "disallows unsafe redirections when :allow_redirections => :safe" do
        ...
        m = MetaInspector.new("https://unsafe-facebook.com", :allow_redirections => :safe, exception_log: logger)
        m.title
      end
